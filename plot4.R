...
par(mfrow=c(2,2))
plot(t,newdf$Global_active_power, type="l", xlab="", ylab = "Global Active Power (kilowatts)")
plot(t, newdf$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(t, newdf$Global_reactive_power, type = "l",  xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
